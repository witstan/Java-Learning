 ...
 *  自定义注解都会通过指明两个元注解：Rentention、Target
 *
 * 4.jdk 提供4种元注解
 *   元注解：对现有的注解进行解释说明的注解
 *   Retention：指定所修饰是Annotation的生命周期：SOURCE/CLASS（默认行为）/RUNTIME
...
//jdk8之前的写法：
//@MyAnnotations({@MyAnnotation(value = "hallo"), @MyAnnotation(value = "hi")})
//@MyAnnotation("hi")
@MyAnnotation(value = "hallo")
