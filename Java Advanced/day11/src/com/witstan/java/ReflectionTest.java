...
public class ReflectionTest {
    ...
    public void test2() throws Exception{
        ...
        //通过反射，可以调用Person类的私有结构的。比如：私有属性、构造器、方法
        //调用私有的构造器
        ...
        String aa = (String)showNation.invoke(p1, "AA");
    ...
    1. 类的加载过程：
    程序经过javac.exe命令后，会生成一个或多个字节码文件（.class结尾），接着我们
    ...
    public void test3() throws ClassNotFoundException {
        ...
        Class clazz3 = Class.forName("com.witstan.java.Person");
//        clazz3 = Class.forName("java.lang.String");
        ...
        Class clazz4 = cl.loadClass("com.witstan.java.Person");
